...
public:
  OdometerBase()
  {
    ...
    // advertise
    odom_pub_ = local_nh.advertise<nav_msgs::Odometry>("odometry_with_dely_assumption", 1);
    pose_pub_ = local_nh.advertise<geometry_msgs::PoseStamped>("pose_with_dely_assumption", 1);
