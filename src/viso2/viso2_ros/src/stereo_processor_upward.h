...
protected:
    ...
    left_received_(0), right_received_(0), left_info_received_(0), right_info_received_(0), all_received_(0)
  {
    ...
    std::string left_topic = ros::names::clean(stereo_ns + "/left_upward/" + nh.resolveName("image"));
    std::string right_topic = ros::names::clean(stereo_ns + "/right_upward/" + nh.resolveName("image"));

    std::string left_info_topic = stereo_ns + "/left_upward/camera_info";
    std::string right_info_topic = stereo_ns + "/right_upward/camera_info";
