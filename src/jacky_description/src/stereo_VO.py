...
def stereo_cb(msg_left, msg_right):
    global cv_left_image_prev, cv_right_image_prev, ini_image_obtained, prev_time, H
    try:
    ...
    if not ini_image_obtained:
        ...
        disparity = stereo.compute(cv_left_image_cur, cv_right_image_cur)
        # Captured the images
        ...
        kp_prev, des_prev, prev_img_w_kp = ORB_detect(cv_left_image_prev, (255, 0, 0))
        kp_cur, des_cur, cur_img_w_kp = ORB_detect(cv_left_image_cur, (0, 255, 0))
