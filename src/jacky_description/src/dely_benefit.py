...
if __name__ == "__main__":
    ...
    try:
        vo_sub_w_dely = rospy.Subscriber("/stereo_odometer_with_dely_assumption/pose_with_dely_assumption", PoseStamped, stereo_cb_w_dely)
        vo_sub_wo_dely = rospy.Subscriber("/stereo_odometer_without_dely_assumption/pose_without_dely_assumption", PoseStamped, stereo_cb_wo_dely)
        rospy.spin()
        ...
        axs[0,0].plot(X_vo, Y_vo,'b-', label = "VO with Delta")
        axs[0,0].plot(nX_vo, nY_vo, 'm-', label = "VO without Delta")
        axs[0,0].set_title("Robot Path")

        axs[0,1].plot(YAW_gt,'r-', label = "GT")
        axs[0,1].plot(YAW_vo,'b-', label = "VO with Delta")
        axs[0,1].plot(nYAW_vo, 'm-', label = "VO without Delta")
        axs[0,1].set_title("Yaw")


        axs[1,0].plot(DELTA_X_GT, 'r-', label = "GT")
        axs[1,0].plot(DELTA_X_VO, 'b-', label = "VO with Delta")
        axs[1,0].plot(nDELTA_X_VO, 'm-', label = "VO without Delta")
        axs[1,0].set_title("Delta x")

        axs[1,1].plot(DELTA_Y_GT, 'r-', label = "GT")
        axs[1,1].plot(DELTA_Y_VO, 'b-', label = "VO with Delta")
        axs[1,1].plot(nDELTA_Y_VO, 'm-', label = "VO without Delta")
