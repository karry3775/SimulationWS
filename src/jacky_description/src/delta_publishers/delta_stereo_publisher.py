...
rospy.init_node("delta_stereo_publisher_node")
# create a publisher
delta_pub = rospy.Publisher("/stereo_odometer/delta_topic", DeltaMsgStamped, queue_size = 10)
...
if __name__ == "__main__":
    try:
        stereo_odom_sub = rospy.Subscriber("/stereo_odometer/odometry", Odometry, stereo_odom_cb)
        rospy.spin()
