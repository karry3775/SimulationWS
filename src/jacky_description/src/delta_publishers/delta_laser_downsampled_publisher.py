...
rospy.init_node("delta_laser_downsampled_publisher_node")
# create a publisher
delta_pub = rospy.Publisher("/laser_odometer_downsampled/delta_topic", DeltaMsgStamped, queue_size = 10)
...
def laser_odom_cb(msg):
    global firstRun, prevx, prevy, prevyaw, skip
    if skip:
        skip = False
        return
    else:
