...
rospy.init_node("delta_stereo_verification_node")
...
if __name__ == "__main__":
    try:
        odom_n_sub = rospy.Subscriber("/stereo_odometer/odometry", Odometry, odom_n_cb)
        odom_f_sub = rospy.Subscriber("/stereo_odometer/delta_topic", DeltaMsgStamped, odom_f_cb)
        rospy.spin()
