...
;//! \htmlinclude SuspensionReport.msg.html

(cl:defclass <SuspensionReport> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass SuspensionReport (<SuspensionReport>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SuspensionReport>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SuspensionReport)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_mkz_msgs-msg:<SuspensionReport> is deprecated: use dbw_mkz_msgs-msg:SuspensionReport instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SuspensionReport>))
...
(cl:defmethod front_left-val ((m <SuspensionReport>))
...
(cl:defmethod front_right-val ((m <SuspensionReport>))
...
(cl:defmethod rear_left-val ((m <SuspensionReport>))
...
(cl:defmethod rear_right-val ((m <SuspensionReport>))
  ...
  (rear_right m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SuspensionReport>) ostream)
  "Serializes a message object of type '<SuspensionReport>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SuspensionReport>) istream)
  "Deserializes a message object of type '<SuspensionReport>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SuspensionReport>)))
  "Returns string type for a message object of type '<SuspensionReport>"
  "dbw_mkz_msgs/SuspensionReport")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SuspensionReport)))
  "Returns string type for a message object of type 'SuspensionReport"
  "dbw_mkz_msgs/SuspensionReport")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SuspensionReport>)))
  "Returns md5sum for a message object of type '<SuspensionReport>"
  "a2c91f746e5d8bec139c834f92ac7468")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SuspensionReport)))
  "Returns md5sum for a message object of type 'SuspensionReport"
  "a2c91f746e5d8bec139c834f92ac7468")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SuspensionReport>)))
  "Returns full string definition for message of type '<SuspensionReport>"
  (cl:format cl:nil "Header header~%~%# Suspension heights (m)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SuspensionReport)))
  "Returns full string definition for message of type 'SuspensionReport"
  (cl:format cl:nil "Header header~%~%# Suspension heights (m)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SuspensionReport>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SuspensionReport>))
  "Converts a ROS message object to a list"
  (cl:list 'SuspensionReport
